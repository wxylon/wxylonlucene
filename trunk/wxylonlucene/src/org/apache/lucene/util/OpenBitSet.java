...
/**
 * An "open" BitSet impl ementation that allows direct access to the array of
 ...
 * <code>OpenBitSet</code> are the fastest implementation possible, and
 * maximum code reuse. Extra safety and encapsulation may always be built on
 ...
 * use <code>java.util.BitSet</code>. <p/>
 ...
 * <td>0.99</td>
 * </tr>
 * </table> <br/> Test system: AMD Opteron, 64 bit linux, Sun Java 1.5_06
 * -server -Xbatch -Xmx64M <br/>BitSet size = 1,000,000 <br/>Results are
 * java.util.BitSet time divided by OpenBitSet time. <table border="1">
 * <tr>
 * <th></th>
 * <th>cardinality</th>
 * <th>intersect_count</th>
...
public class OpenBitSet extends DocIdSet implements Cloneable, Serializable {
	...
	public static long intersectionCount(OpenBitSet a, OpenBitSet b) {
		return BitUtil.pop_intersect(a.bits, b.bits, 0, Math
				.min(a.wlen, b.wlen));
	}
	...
	public static long unionCount(OpenBitSet a, OpenBitSet b) {
		long tot = BitUtil.pop_union(a.bits, b.bits, 0, Math
				.min(a.wlen, b.wlen));
		if (a.wlen < b.wlen) {
	...
	public static long andNotCount(OpenBitSet a, OpenBitSet b) {
		long tot = BitUtil.pop_andnot(a.bits, b.bits, 0, Math.min(a.wlen,
				b.wlen));
		if (a.wlen > b.wlen) {
			tot += BitUtil.pop_array(a.bits, b.wlen, a.wlen - b.wlen);
		}
	...
	public Object clone() {
		try {
			...
			obs.bits = (long[]) obs.bits.clone(); // hopefully an array clone
													// is as fast(er) than
													// arraycopy
			return obs;
