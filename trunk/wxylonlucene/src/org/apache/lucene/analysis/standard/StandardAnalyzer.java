...
/**
 * 此类描述的是：表面上看它是按空格切分，然后去掉一些停用词， 但实际上它有很强的token识别功能，
 * 			  像”xyz@example.com”这样的字符串它可以识别为email
 * @version 创建时间：Oct 13, 2009 5:01:49 PM
 */
public class StandardAnalyzer extends Analyzer {
	 ...
	 * 
	 * @param replaceInvalidAcronym
	 *            Set to true if this analyzer should replace mischaracterized
