...
final class SegmentInfos extends Vector {
	...
	/**
	 * This format adds a checksum at the end of the file to ensure all bytes
	 * were successfully written.
	 */
	public static final int FORMAT_CHECKSUM = -5;

	/**
	 * This format adds the deletion count for each segment. This way
	 * IndexWriter can efficiently report numDocs().
	 */
	public static final int FORMAT_DEL_COUNT = -6;

	/**
	 * This format adds the boolean hasProx to record if any fields in the
	 * segment store prox information (ie, have omitTf==false)
	 */
	...
	private final void write(Directory directory) throws IOException {
		...
		ChecksumIndexOutput output = new ChecksumIndexOutput(directory
				.createOutput(segmentFileName));
	 ...
	 * readers. Once this is called you must call {@link #finishCommit} to
