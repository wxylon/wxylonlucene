...
final class FieldInfos {
	 ...
	 */
	synchronized public void addIndexed(Collection names,
	...
	synchronized public FieldInfo add(String name, boolean isIndexed,
			boolean storeTermVector, boolean storePositionWithTermVector,
			boolean storeOffsetWithTermVector, boolean omitNorms,
			boolean storePayloads, boolean omitTf) {
		...
		if (fi == null) {
			return addInternal(name, isIndexed, storeTermVector,
					...
					.update(isIndexed, storeTermVector,
							storePositionWithTermVector,
							storeOffsetWithTermVector, omitNorms,
							storePayloads, omitTf);
		}
		return fi;
	}
	...
	synchronized public FieldInfo add(FieldInfo fieldInfo) {
		...
		if (fi == null) {
			return addInternal(fieldInfo.name, fieldInfo.isIndexed,
					...
					fieldInfo.storeOffsetWithTermVector, fieldInfo.omitNorms,
					fieldInfo.storePayloads, fieldInfo.omitTf);
		} else {
			fi.update(fieldInfo);
		}
		return fi;
