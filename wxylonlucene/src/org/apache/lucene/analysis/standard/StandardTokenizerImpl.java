...
/*
 * 
 * NOTE: if you change this file and need to regenerate the tokenizer, remember
 * to use JRE 1.4 when running jflex (before Lucene 3.0). This grammar now uses
 * constructs (eg :digit:) whose meaning can vary according to the JRE used to
 * run jflex. See https://issues.apache.org/jira/browse/LUCENE-1126 for details
 * 
 */
 ...
 * 1.4.1 on 9/4/08 6:49 PM from the specification file
